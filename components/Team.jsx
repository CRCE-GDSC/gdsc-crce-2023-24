...
const Team = () => {
    const Members = [
        ...
        {
            name: 'Zane Falcao',
            imgSrc:"/../public/assets/team/Zane.jpg",
            position: 'Web Development Associate',
            linkedIn:'',
            Instagram: '',
        },
                ...
                <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12 ">
                    {Members.map((Member, index) =>(
                            ...
                            <div
                                ...
                                className="block h-full rounded-lg bg-gray-500 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
