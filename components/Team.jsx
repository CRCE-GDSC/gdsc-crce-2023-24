    ...
    <>  
        <div className="container my-24 mx-auto md:px-6 bg-blue-100 max-w-full pt-10">
            ...
            <section className="mb-32 text-center">
                ...
                <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12 ">
                    {Seniors23.map((Member, index) =>(
                            ...
                            <div
                                ...
                                className="block h-full rounded-lg bg-amber-50 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:bg-orange-50 hover:translate-y-5">
                ...
                <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12 ">
                    {Juniors23.map((Member, index) =>(
                            ...
                            <div
                                ...
                                className="block h-full rounded-lg bg-amber-50 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:bg-blue-700">
                                <div className="flex justify-center">
                                    <div className="flex justify-center -mt-[75px]">
                                        <Image 
                                            src={Member.imgSrc} 
                ...
                <h3 className='text-3xl font-semibold mb-10'>GDSC JUNIOR CABINET 2022-24</h3>
                <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12 ">
