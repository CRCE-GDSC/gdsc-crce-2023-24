...
const Seniors24 =[
    ...
    {
        name: 'Arnav Pandita',
        imgSrc:"/assets/team/arnav3.jpeg",
        position: 'GDSC Lead',
    ...
    },
    {
        ...
        imgSrc:"/assets/team/chhand2.jpeg",
...
const Juniors24 = [
    ...
    {
        name: 'Leora Dias',
        imgSrc:"/assets/team/Leora_Dias.jpg",
    ...
    {
        name: 'Aditi Singh',
        imgSrc:"/assets/team/aditi_singh.jpg",
        position: 'Graphic Design Associate',
    ...
    {
        name: "Samuel D'Souza",
        imgSrc:"/assets/team/samuel.jpeg",
        position: 'GDSC Associate',
        linkedIn:'',
        Instagram: '',
    },
    {
        name: 'Sakshi Kupekar',
        imgSrc:"/assets/team/Sakshi_Kupekar.jpg",
        position: 'GDSC Associate',
    ...
    {
        name: 'Saumitra Gurav',
        imgSrc:"/assets/team/SaumitraGurav.jpg",
        position: 'GDSC Associate',
                                ...
                                <div
                                    ...
                                    <div className="p-5">
                                        ...
                                        { (Member.linkedIn || Member.Instagram) ?(
                                            ...
                                            */}
                                            <a href={Member.Instagram} target='_blank' className="p-4 rounded-full text-slate-500 hover:bg-pink-300 hover:text-white">
                                                {/* Instagram */}
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                className="h-4 w-4 text-primary color-class-insta">
                                                <path fill="currentColor"
                                            ...
                                            <a href={Member.linkedIn} target='_blank' className="p-4 rounded-full text-slate-500 hover:bg-blue-300 hover:text-white">
                                                {/*Linkedin -->*/}
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                className="h-4 w-4 text-primary color-class-Ln">
                                                <path fill="currentColor"
                                ...
                                <div
                                    ...
                                    <div className="p-5">
                                        ...
                                        { (Member.linkedIn || Member.Instagram) ?(
                                            ...
                                            */}
                                            <a href={Member.Instagram} className="p-4 rounded-full text-slate-500 hover:bg-pink-300 hover:text-white">
                                                {/* Instagram */}
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                className="h-4 w-4 text-primary ">
                                                <path fill="currentColor"
