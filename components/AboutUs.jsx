...
const AboutUs = () => {
  return (
<<<<<<< Updated upstream
    <div className="container mx-auto scroll-mt-96 xl:py-16 mt-10 max-sm:pt-20"  id="about">
        <h3 className="text-gray-700 font-semibold text-5xl mb-6 py-3 font-poppins text-center">About Us</h3>
=======
    <div className="container mx-auto scroll-mt-96 xl:py-16 mt-10"  id="about">
        <h3 className="text-5xl text-[#515e68] mb-6 mt-10 text-center pb-10 bg-[#fdfdfd] max-sm:pt-14 max-sm:text-4xl max-sm:mb-0 font-medium ">About Us</h3>
>>>>>>> Stashed changes
