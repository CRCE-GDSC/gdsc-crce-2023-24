    ...
    <div className="sticky lg:px-[100px] top-0 bg-white z-10 mx-auto shadow-lg">
      <div className="flex w-full">
        ...
        <div className='flex max-sm:hidden'>
          ...
          <Link href='#about' className='py-6 blue_link'>About Us</Link>
          <Link href='#what' className='py-6 blue_link'>What We Do</Link>
          <Link href='#events' className='py-6 blue_link'>Events</Link>
          <Link href='#team' className='py-6 blue_link'>Our Team</Link>
          <Link href='#foot' className='py-6 blue_link'>Contact Us</Link>
        </div>
      </div>
    </div>
  </div>
